...
const MER_ID = '898111473990162';

 
// ######(以下配置为PM环境：入网测试环境用，生产环境配置见文档说明)#######
// 签名证书路径
const SDK_SIGN_CERT_PATH = 'ThinkPHP/Library/Org/Pay/UnionPay/certs/PM_700000000000001_acp.pfx';

// 签名证书密码
 const SDK_SIGN_CERT_PWD = '000000';

// 密码加密证书（这条用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = 'ThinkPHP/Library/Org/Pay/UnionPay/certs/verify_sign_acp.cer';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://127.0.0.1/alw/home/PayBackFront/UnionPayBack';
// 后台通知地址 (商户自行配置通知地址)
const SDK_BACK_NOTIFY_URL = 'http://127.0.0.1/alw/home/PayBackBack/UnionPayBack';
